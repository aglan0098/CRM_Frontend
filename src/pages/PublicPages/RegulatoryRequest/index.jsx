...
const RegulatoryRequest = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Organization Support Request', path: '/RegulatoryRequest', active: true },
  ];
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-base text-text-primary mb-10">
                  This service allows government and private entities to submit requests or inquiries to obtain organizational support services, which are services governed by legal standards aimed at addressing issues related to the water sector infrastructure
                </p>
...
export default RegulatoryRequest;