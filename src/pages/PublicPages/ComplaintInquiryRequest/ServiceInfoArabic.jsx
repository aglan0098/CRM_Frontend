  ...
  return (
    <div className="bg-white rounded-2xl border border-border-primary p-10" dir="rtl">
      <div className="flex items-start mb-10">
        ...
        <div className="mr-8">
          <h3 className="text-base font-bold text-text-secondary mb-1">الفئة المستهدفة</h3>
      ...
      <div className="flex items-start mb-10">
        ...
        <div className="mr-8">
          ...
          <p className="text-base text-text-secondary">مجانية</p>
        </div>
      </div>
      ...
      <a href="#" className="flex items-center text-text-green mb-10">
        <span className="text-base">صفحة الأسئلة الشائعة - مياه الرياض</span>
