...
const Complaintinquiryrequest = () => {
  const framesRef = useRef(null);
  const controlsRef = useRef(null);

  useEffect(() => {
    const frames = framesRef.current;
    const cards = frames ? Array.from(frames.querySelectorAll('.In-Service-Card')) : [];
    const controls = controlsRef.current;
    const dots = controls ? Array.from(controls.querySelectorAll('.In-Carousal')) : [];
    ...
    function updateDots(activeIndex) {
      dots.forEach((dot, i) => {
        const indicator = dot.querySelector('.In-Carousal-Img');
        if (!indicator) return;
        if (i === activeIndex) {
    ...
    function onResize() {
      ...
      rafId = requestAnimationFrame(() => {
        const activeIndex = dots.findIndex((d) =>
          d.querySelector('.In-Carousal-Img')?.classList.contains('active')
        );
        computeOffsets();
  ...
  return (
    <>                
      ...
      <div className="In-Gate">
        ...
        <div className="In-Serivce">
          <div className="In-Serivce-Info">
            <div className="In-Description">
              <div className="In-Content">
                <div className="In-Title">
                  <div className="In-Breadcrumb">
                    <div className="In-_Breadcrumb-Item">Main Page</div>
                    <div className="In-_Breadcrumb-Item">
                    ...
                    <div className="In-_Breadcrumb-Item In-_Breadcrumb-Item-Text">
                      <div className="In-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" viewBox="0 0 6 12" fill="none">
                          <path d="M1 1L5 6L1 11" stroke="#9DA4AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                  ...
                  <div className="In-T_Title">Complaint Inquiry Service​</div>
                </div>
                <button
                  type="button"
                  className="In-Button"
              ...
              <div className="In-T-Description">
              ...
              <a
                ...
                href="https://swa-cdn.swa.gov.sa/ServiceGuides/en/Complaint_Inquiry_Service_EN.pdf"
                target="_blank"
            ...
            <div className="In-Info">
              <div className="In-Hor-Tab-List">
                <div className="In-Hor-Tab In-Hor-Tab--active">Steps</div>
              </div>
              <div className="In-Tab-Panel">
                <div className="In-Steps" role="tabpanel">
                  <div className="In-List-Item">
                    <div className="In-T-Steps-Num">1-</div>
                    <div className="In-T-Steps-Text">
                      The complaint number must be provided by the user.
                    </div>
                  </div>
                  <div className="In-List-Item">
                    <div className="In-T-Steps-Num">2-</div>
                    <div className="In-T-Steps-Text">
          ...
          <div className="In-Info-Card">
            <div className="In-IC-Service-Info">
              <div className="In-IC-SI-Content">
                ...
                <div className="In-Inner-Content">
                  <div className="In-Inner-Content-T1">Target audience</div>
                  <div className="In-Inner-Content-T2-Blk">Individual</div>
                </div>
              </div>
              <div className="In-IC-SI-Content">
                <div className="In-User">
                ...
                <div className="In-Inner-Content">
                  <div className="In-Inner-Content-T1">Service duration</div>
                  <div className="In-Inner-Content-T2-Blk">Instant</div>
                </div>
              </div>
              <div className="In-IC-SI-Content">
                <div className="In-User">
                ...
                <div className="In-Inner-Content">
                  <div className="In-Inner-Content-T1">Service channels</div>
                  <div className="In-Inner-Content-T2-Blk">Services portal</div>
                </div>
              </div>
              <div className="In-IC-SI-Content">
                <div className="In-User">
                ...
                <div className="In-Inner-Content">
                  <div className="In-Inner-Content-T1">Service cost</div>
                  <div className="In-Inner-Content-T2-Blk">Free</div>
                </div>
              </div>
            </div>

            <hr className="In-Line-1" />

            <div className="In-Contact-Info">
              <div className="In-Inner-Content-Lower">
                <div className="In-Inner-Content-Lower-T1">
                  Frequently Asked Questions
                </div>
                <div className="In-Inner-Content-Lower-T2">
                  <a href="https://www.swa.gov.sa/ar/faq" target="_blank" className="underline">
                      SWA-FAQ's-page
                  </a>
                  <div className="In-Inner-Content-Lower-T2-Img">
              ...
              <div className="In-IC-SI-Content">
                ...
                <div className="In-Inner-Content">
                  <div className="In-Inner-Content-T1">Phone</div>
                  <div className="In-Inner-Content-T2">
        ...
        <div className="In-Footer-Above">
          <div className="In-Comments-N-Suggestons">
            <div className="In-CnS-Card">
              <div className="In-Cns-Card-Icon-Div">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
              ...
              <div className="In-CnS-Card-Content">
                <div className="In-CnS-Card-Content-T1">Comments & suggestions</div>
                <div className="In-CnS-Card-Content-T2">
                  For any inquiry or feedback on Government Services, please fill
                  the required information.
                </div>
              </div>
              <div className="In-Cns-Card-Actions">
                <a href="https://www.swa.gov.sa/ar/communication-channels" target="_blank" className="CnS-Card-Button">Contact us</a>
              </div>
            </div>
          </div>

          <div className="In-Modified-Date">
            <div className="In-Modified-Date-T">
              Last Modified Date: 04/12/2020 - 4:13 PM Saudi Arabia Time
            </div>
          </div>

          <div className="In-Rating">
            <div className="In-Rating-body">
              <div className="In-Rating-Content">
                <div className="In-Rating-Content-Left-Text-T">
                  This service is rated with an average of
                  <span className="In-Rating-Content-Left-Digit-T"> 3.9</span>
                </div>
                <div className="In-RatingStar">
                ...
                <div className="In-Rating-Content-Right-T">1544 reviews</div>
              </div>
              <div className="In-Rating-Actions">
                <div className="In-Rate-Tag">Rate this service</div>
              </div>
            </div>
          </div>

          <div className="In-Feedback">
            <div className="In-Feedback-Section">
              <div className="In-Feedback-Section-Content">
                <div className="In-Content-Text">Was this page useful?</div>
                <div className="In-Content-Actions">
                  <button className="In-choice">Yes</button>
                  <button className="In-choice">No</button>
                </div>
              </div>
              <div className="In-Feedback-Section-Text">
...
export default Complaintinquiryrequest;