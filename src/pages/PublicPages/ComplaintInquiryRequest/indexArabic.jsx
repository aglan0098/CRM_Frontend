...
const ComplaintinquiryrequestArabic = () => {
    const framesRef = useRef(null);
    const controlsRef = useRef(null);

    useEffect(() => {
        const frames = framesRef.current;
        const cards = frames ? Array.from(frames.querySelectorAll('.In-Service-CardAr')) : [];
        const controls = controlsRef.current;
        const dots = controls ? Array.from(controls.querySelectorAll('.In-CarousalAr')) : [];
        ...
        function updateDots(activeIndex) {
            dots.forEach((dot, i) => {
                const img = dot.querySelector('.In-Carousal-ImgAr');
                if (!img) return;
        ...
        function onResize() {
            ...
            rafId = requestAnimationFrame(() => {
                const activeIndex = dots.findIndex(
                    (d) => d.querySelector('.In-Carousal-ImgAr')?.classList.contains('In-active')
                );
                computeOffsets();
    ...
    return (
        <>
            ...
            <div className="In-GateAr">

                <div className="In-SerivceAr">
                    {/* <img src="styles/vector.png" alt="Vector" className="In-Vector-imgAr" /> */}

                    <div className="In-Serivce-InfoAr">
                        <div className="In-DescriptionAr">
                            <div className="In-ContentAr">
                                <div className="In-TitleAr">
                                    <div className="In-BreadcrumbAr">
                                        <div className="In-_Breadcrumb-ItemAr">الرئيسية</div>
                                        <div className="In-_Breadcrumb-ItemAr">
                                            <div className="In-arrowAr">
                                        ...
                                        <div className="In-_Breadcrumb-ItemAr In-_Breadcrumb-Item-TextAr">
                                            <div className="In-arrowAr">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" viewBox="0 0 6 12" fill="none">
                                                    <path d="M1 1L5 6L1 11" stroke="#9DA4AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                            </div>خدمة الاستعلام عن الشكوى</div>
                                    </div>
                                    <div className="In-T_TitleAr">خدمة الاستعلام عن الشكوى</div>
                                </div>
                                <button
                                    type="button"
                                    className="In-ButtonAr"
                                    onClick={() => navigate('/ComplaintInquiry')}
                                >
                                    طلب الخدمة
                                </button>
                            </div>
                            <div className="In-T-DescriptionAr">تتيح هذه المنصة للمستفيدين الاستعلام عن حالة وتفاصيل شكاوى المياه، والصرف الصحي الخاصة بهم.</div>
                            <a
                                className="LinkAr underline"
                                href="https://swa-cdn.swa.gov.sa/ServiceGuides/ar/Complaint_Inquiry_Service_AR.pdf"
                                target="_blank"
                        ...
                        <div className="In-InfoAr">
                            <div className="In-Hor-Tab-ListAr" role="tablist">
                                <button
                                    type="button"
                                    role="tab"
                                    aria-selected={activeTab === 'steps'}
                                    className={`In-Hor-TabAr${activeTab === 'steps' ? ' In-Hor-Tab--active' : ''
                                        }`}
                            ...
                            <div className="In-Tab-PanelAr">
                                {activeTab === 'steps' && (
                                    <div className="In-StepsAr" role="tabpanel">
                                        <div className="In-List-ItemAr">
                                            <div className="In-T-Steps-NumAr">1-</div>
                                            <div className="In-T-Steps-TextAr">يجب على المستخدم إدخال رقم الجوال.</div>
                                        </div>
                                        <div className="In-List-ItemAr">
                                            <div className="In-T-Steps-NumAr">2-</div>
                                            <div className="In-T-Steps-TextAr">يجب إدخال رقم الهوية أو الإقامة لمقدم الشكوى.</div>
                                        </div>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="In-Info-CardAr">
                        <div className="In-IC-Service-InfoAr">
                            <div className="In-IC-SI-ContentAr">
                                <div className="In-UserAr">
                                ...
                                <div className="In-Inner-ContentAr">
                                    <div className="In-Inner-Content-T1Ar">الفئة المستهدفة</div>
                                    <div className="In-Inner-Content-T2Ar-Blk">الأفراد</div>
                                </div>
                            </div>
                            <div className="In-IC-SI-ContentAr">
                                <div className="In-UserAr">
                                ...
                                <div className="In-Inner-ContentAr">
                                    <div className="In-Inner-Content-T1Ar">مدة تنفيذ الخدمة</div>
                                    <div className="In-Inner-Content-T2Ar-Blk">فوري</div>
                                </div>
                            </div>
                            <div className="In-IC-SI-ContentAr">
                                <div className="In-UserAr">
                                ...
                                <div className="In-Inner-ContentAr">
                                    <div className="In-Inner-Content-T1Ar">قنوات تقديم الخدمة</div>
                                    <div className="In-Inner-Content-T2Ar-Blk">بوابة الخدمات</div>
                                </div>
                            </div>
                            <div className="In-IC-SI-ContentAr">
                                <div className="In-UserAr">
                                ...
                                <div className="In-Inner-ContentAr">
                                    <div className="In-Inner-Content-T1Ar">تكلفة الخدمة</div>
                                    <div className="In-Inner-Content-T2Ar-Blk">مجاني</div>
                                </div>
                            </div>
                        </div>

                        <hr className="In-Line-1Ar" />

                        <div className="In-Contact-InfoAr">
                            <div className="In-Inner-Content-LowerAr">
                                <div className="In-Inner-Content-Lower-T1Ar">
                                    الأسئلة الشائعة
                                </div>
                                <div className="In-Inner-Content-Lower-T2Ar">
                                    <a href="https://www.swa.gov.sa/ar/faq" target="_blank" className="underline">
                                         صفحة الأسئلة الشائعة - SWA
                                    </a>
                                    <div className="In-Inner-Content-Lower-T2-ImgAr">
                            ...
                            <div className="In-IC-SI-ContentAr">
                                ...
                                <div className="In-Inner-ContentAr">
                                    <div className="In-Inner-Content-T1Ar">الهاتف</div>
                                    <div className="In-Inner-Content-T2Ar">
                ...
                <div className="In-Footer-AboveAr">
                    <div className="In-Comments-N-SuggestonsAr">
                        <div className="In-CnS-CardAr">
                            <div className="In-Cns-Card-Icon-DivAr">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                            ...
                            <div className="In-CnS-Card-ContentAr">
                                <div className="In-CnS-Card-Content-T1Ar">التعليقات والاقتراحات</div>
                                <div className="In-CnS-Card-Content-T2Ar">
                                    لأي استفسار أو ملاحظات حول الخدمات الحكومية، يرجى ملء
                                    المعلومات المطلوبة.
                                </div>
                            </div>
                            <div className="In-Cns-Card-ActionsAr">
                                <a href="https://www.swa.gov.sa/ar/communication-channels" target="_blank" className="CnS-Card-Button">اتصل بنا</a>
                            </div>
                        </div>
                    </div>

                    <div className="In-Modified-DateAr">
                        <div className="In-Modified-Date-TAr">
                            تاريخ آخر تعديل: 04/12/2020 - 4:13 مساءً بتوقيت المملكة العربية السعودية
                        </div>
                    </div>

                    <div className="In-RatingAr">
                        <div className="In-Rating-bodyAr">
                            <div className="In-Rating-ContentAr">
                                <div className="In-Rating-Content-Right-TAr">1544 تقييم</div>
                                <div className="In-RatingStarAr">
                                ...
                                <div className="In-Rating-Content-Left-Text-TAr">
                                    تم تقييم هذه الخدمة بمتوسط
                                    <span className="In-Rating-Content-Left-Digit-TAr">3.9</span>
                                </div>
                            </div>
                            <div className="In-Rating-ActionsAr">
                                <div className="In-Rate-TagAr">قيّم هذه الخدمة</div>
                            </div>
                        </div>
                    </div>

                    <div className="In-FeedbackAr">
                        <div className="In-Feedback-SectionAr">
                            <div className="In-Feedback-Section-ContentAr">
                                <div className="In-Content-TextAr">هل كانت هذه الصفحة مفيدة؟</div>
                                <div className="In-Content-ActionsAr">
                                    <button className="In-choiceAr">نعم</button>
                                    <button className="In-choiceAr">لا</button>
                                </div>
                            </div>
                            <div className="In-Feedback-Section-TextAr">
...
export default ComplaintinquiryrequestArabic;
