  ...
  const services = [
    {
      ...
      tag: 'فردي',
      buttonText: 'الانتقال إلى الخدمة',
    ...
    },
    {
      ...
      description:
        'تساعد حاسبة فاتورة المياه المستخدمين في تقدير فاتورة المياه بناءً على الاستهلاك، وحساب التكاليف وفقاً للاستخدام والتعريفات المعمول بها.',
      tag: 'فردي',
      buttonText: 'الانتقال إلى الخدمة',
    ...
    <div className="bg-secondary-light py-10" dir="rtl">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        ...
        <p className="text-sm sm:text-base text-text-primary mb-10 max-w-3xl">
          مثال على وصف الخدمة: لشراء قطعة أرض لبناء منزلك، يتطلب ذلك توثيق عملية البيع والشراء في مكاتب كاتب العدل أو خدمات التوثيق لتسجيل العقار باسمك.
        </p>
        ...
        <div className="flex justify-center mt-10 space-x-2 space-x-reverse" role="tablist" aria-label="شرائح الخدمات ذات الصلة">
          {[0, 1, 2].map((index) => (
            <button
              key={index}
