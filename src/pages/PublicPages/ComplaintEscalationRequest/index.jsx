...
const Complaintescalationrequest = () => {
  const framesRef = useRef(null);
  const controlsRef = useRef(null);

  useEffect(() => {
    const frames = framesRef.current;
    const cards = frames ? Array.from(frames.querySelectorAll('.Service-Card')) : [];
    const controls = controlsRef.current;
    const dots = controls ? Array.from(controls.querySelectorAll('.Carousal')) : [];
    ...
    function updateDots(activeIndex) {
      dots.forEach((dot, i) => {
        const indicator = dot.querySelector('.Carousal-Img');
        if (!indicator) return;
        if (i === activeIndex) {
    ...
    function onResize() {
      ...
      rafId = requestAnimationFrame(() => {
        const activeIndex = dots.findIndex((d) =>
          d.querySelector('.Carousal-Img')?.classList.contains('active')
        );
        computeOffsets();
    ...
    <>                <Nv language={language} onLanguageChange={handleLanguageChange} />
      ...
      <div className="Gate">
        ...
        <div className="Serivce">
          {/* <img src="styles/vector.png" alt="Vector" className="Vector-img" /> */}
          ...
          <div className="Serivce-Info">
            <div className="Description">
              <div className="Content">
                <div className="Title">
                  <div className="Breadcrumb">
                    <div className="_Breadcrumb-Item">Main Page</div>
                    <div className="_Breadcrumb-Item">
                      <div className="arrow">
                    ...
                    <div className="_Breadcrumb-Item _Breadcrumb-Item-Text">
                      <div className="arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" viewBox="0 0 6 12" fill="none">
                          <path d="M1 1L5 6L1 11" stroke="#9DA4AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                  ...
                  <div className="T_Title">Complaint escalation service</div>
                </div>
                <button
                  type="button"
                  className="Button"
              ...
              <div className="T-Description">
                This service allows beneficiaries to escalate their complaints to the Authority if the complaint was closed by the service provider without resolution, or if ten (10) business days have passed without a response.
              </div>
              <a
                className="Link underline"
                href="https://swa-cdn.swa.gov.sa/ServiceGuides/en/Complaint_Escalation_Service_EN.pdf"
                target="_blank"
            ...
            <div className="Info">
              <div className="Hor-Tab-List" role="tablist">
                {[
                  { id: 'goals', label: 'Service Objectives' },
                  { id: 'steps', label: 'Application Process' },
                  { id: 'policy', label: 'Terms of Use' },
                  ...
                  <button
                    ...
                    className={`Hor-Tab${activeTab === tab.id ? ' Hor-Tab--active' : ''
                      }`}
                    onClick={() => {
                      setActiveTab(tab.id);
              ...
              <div className="Tab-Panel">
                {activeTab === 'steps' && (
                  <div className="Steps" role="tabpanel">
                    <div className="List-Item">
                      <div className="T-Steps-Num">1-</div>
                      <div className="T-Steps-Text">
                        Access the official website of the Saudi Water Authority.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">2-</div>
                      <div className="T-Steps-Text">
                       	Log in to the electronic portal via the National Single Sign-On (SSO).
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">3-</div>
                      <div className="T-Steps-Text">
                        	Select the Complaint Escalation Service from the list of e-services.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">4-</div>
                      <div className="T-Steps-Text">
                       	Complete the personal information.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">5-</div>
                      <div className="T-Steps-Text">Enter the complaint details.</div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">6-</div>
                      <div className="T-Steps-Text">
                        Attach supporting documents (optional).
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">7-</div>
                      <div className="T-Steps-Text">
                        	Confirm the accuracy of the provided information.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">8-</div>
                      <div className="T-Steps-Text">
                        	Submit the request.
                      </div>
                    </div>
                ...
                {activeTab === 'policy' && (
                  <div className="Tab-Panel-Body" role="tabpanel">
                    <div className="List-Item">
                      <div className="T-Steps-Num">1-</div>
                      <div className="T-Steps-Text">
                        The applicant must be the beneficiary or the account owner concerned with the service.
                      </div>
                    </div>
                    {/* <ul className="Tab-List Tab-List--bulleted">
                      <li>Billing complaints</li>
                      <li>Water shortage</li>
                      <li>Tanker requests</li>
                      <li>Water and sewage connection requests</li>
                      <li>Licenses</li>
                    </ul> */}
                    <div className="List-Item">
                      <div className="T-Steps-Num">2-</div>
                      <div className="T-Steps-Text">
                        A prior complaint must be registered with the service provider.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">3-</div>
                      <div className="T-Steps-Text">
                        A period of (10) working days must have passed without the complaint being resolved, or the complaint must have been closed without a satisfactory resolution.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">4-</div>
                      <div className="T-Steps-Text">
                        The escalation must not exceed (30) days from the date the complaint was closed by the service provider.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">5-</div>
                      <div className="T-Steps-Text">
                        The complaint reference number registered with the service provider must be provided.
                      </div>
                    </div>
                  </div>
                )}
                {activeTab === 'requirements' && (
                  <div className="Tab-Panel-Body" role="tabpanel">
                    <div className="List-Item">
                      <div className="T-Steps-Text">
                        Supporting documents related to the complaint may be attached in PDF, PNG, or JPG formats, 
within the maximum number of files allowed by the system.
                      </div>
                    </div>
                  </div>
                )}
                 {activeTab === 'goals' && (
                  <div className="Tab-Panel-Body" role="tabpanel">
                    <div className="List-Item">
                      <div className="T-Steps-Num">1-</div>
                      <div className="T-Steps-Text">
                       Enable the Saudi Water Authority to perform its regulatory and supervisory role in ensuring that water service providers comply with approved laws and regulations.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">2-</div>
                      <div className="T-Steps-Text">
                        Protect beneficiaries’ rights and ensure that their complaints are addressed in accordance with approved regulatory procedures.
                      </div>
                    </div>
                    <div className="List-Item">
                      <div className="T-Steps-Num">3-</div>
                      <div className="T-Steps-Text">
                        Enhance the quality of water and wastewater services and improve compliance levels across the water sector ecosystem in the Kingdom.
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div className="Info-Card">
            <div className="IC-Service-Info">
              <div className="IC-SI-Content">
                ...
                <div className="Inner-Content">
                  <div className="Inner-Content-T1">Target audience</div>
                  <div className="Inner-Content-T2-Blk">Individual</div>
                </div>
              </div>
              <div className="IC-SI-Content">
                <div className="User">
                ...
                <div className="Inner-Content">
                  <div className="Inner-Content-T1">Service duration</div>
                  <div className="Inner-Content-T2-Blk">5 Day(s)</div>
                </div>
              </div>
              <div className="IC-SI-Content">
                <div className="User">
                ...
                <div className="Inner-Content">
                  <div className="Inner-Content-T1">Service channels</div>
                  <div className="Inner-Content-T2-Blk">Services portal</div>
                </div>
              </div>
              <div className="IC-SI-Content">
                <div className="User">
                ...
                <div className="Inner-Content">
                  <div className="Inner-Content-T1">Service cost</div>
                  <div className="Inner-Content-T2-Blk">Free</div>
                </div>
              </div>
            </div>
            ...
            <div className="Contact-Info">
              <div className="Inner-Content-Lower">
                <div className="Inner-Content-Lower-T1">
                  Frequently Asked Questions
                </div>
                <div className="Inner-Content-Lower-T2">
                 <a href="https://www.swa.gov.sa/ar/faq" target="_blank" className="underline" onClick={() => trackEvent('ec_faq_clk')}>
                      SWA-FAQ's-page
                  </a>
                  <div className="Inner-Content-Lower-T2-Img">
              ...
              <div className="IC-SI-Content">
                ...
                <div className="Inner-Content">
                  <div className="Inner-Content-T1">Phone</div>
                  <div className="Inner-Content-T2" onClick={() => trackEvent('ec_ph_clk')}>
        ...
        <div className="Footer-Above">
          <div className="Comments-N-Suggestons">
            <div className="CnS-Card">
              <div className="Cns-Card-Icon-Div">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
              ...
              <div className="CnS-Card-Content">
                <div className="CnS-Card-Content-T1">Comments & suggestions</div>
                <div className="CnS-Card-Content-T2">
                  For any inquiry or feedback on Government Services, please fill
                  the required information.
                </div>
              </div>
              <div className="Cns-Card-Actions">
                <a href="https://www.swa.gov.sa/ar/communication-channels" target="_blank" className="CnS-Card-Button" onClick={() => trackEvent('ec_ctc_clk')}>Contact us</a>
              </div>
            </div>
          </div>

          <div className="Modified-Date">
            <div className="Modified-Date-T">
          ...
          <div className="Rating">
            <div className="Rating-body">
              <div className="Rating-Content">
                <div className="Rating-Content-Left-Text-T">
                  This service is rated with an average of
                  <span className="Rating-Content-Left-Digit-T"> 3.9</span>
                </div>
                ...
                <div className="Rating-Content-Right-T">1544 reviews</div>
              </div>
              <div className="Rating-Actions">
                <div className="Rate-Tag">Rate this service</div>
              </div>
            </div>
          </div>
          ...
          <div className="Feedback">
            <div className="Feedback-Section">
              <div className="Feedback-Section-Content">
                <div className="Content-Text">Was this page useful?</div>
                <div className="Content-Actions">
                  <button className="choice">Yes</button>
                  <button className="choice">No</button>
                </div>
              </div>
...
export default Complaintescalationrequest;