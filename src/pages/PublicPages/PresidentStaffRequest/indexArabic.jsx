...
const PresidentContactRequesArabic = () => {
    const framesRef = useRef(null);
    const controlsRef = useRef(null);

    useEffect(() => {
        const frames = framesRef.current;
        const cards = frames ? Array.from(frames.querySelectorAll('.Ps-Service-CardAr')) : [];
        const controls = controlsRef.current;
        const dots = controls ? Array.from(controls.querySelectorAll('.Ps-CarousalAr')) : [];
        ...
        function updateDots(activeIndex) {
            dots.forEach((dot, i) => {
                const img = dot.querySelector('.Ps-Carousal-ImgAr');
                if (!img) return;
        ...
        function onResize() {
            ...
            rafId = requestAnimationFrame(() => {
                const activeIndex = dots.findIndex(
                    (d) => d.querySelector('.Ps-Carousal-ImgAr')?.classList.contains('Ps-active')
                );
                computeOffsets();
    ...
    return (
        <>
            ...
            <div className="Ps-GateAr">

                <div className="Ps-SerivceAr">
                    {/* <img src="styles/vector.png" alt="Vector" className="Ps-Vector-imgAr" /> */}

                    <div className="Ps-Serivce-InfoAr">
                        <div className="Ps-DescriptionAr">
                            <div className="Ps-ContentAr">
                                <div className="Ps-TitleAr">
                                    <div className="Ps-BreadcrumbAr">
                                        <div className="Ps-_Breadcrumb-ItemAr">الرئيسية</div>
                                        <div className="Ps-_Breadcrumb-ItemAr">
                                            <div className="Ps-arrowAr">
                                        ...
                                        <div className="Ps-_Breadcrumb-ItemAr Ps-_Breadcrumb-Item-TextAr">
                                            <div className="Ps-arrowAr">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" viewBox="0 0 6 12" fill="none">
                                                    <path d="M1 1L5 6L1 11" stroke="#9DA4AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                            </div>تواصل مع معالي رئيس الهيئة السعودية للمياه</div>
                                    </div>
                                    <div className="Ps-T_TitleAr">تواصل مع معالي رئيس الهيئة السعودية للمياه</div>
                                </div>
                                <button
                                    type="button"
                                    className="Ps-ButtonAr"
                                    onClick={() => navigate('/PresidentStaff')}
                                >
                                    طلب الخدمة
                                </button>
                            </div>
                            <div className="Ps-T-DescriptionAr">تعزيز سُبل التواصل مع المستفيدين من صميم توجهاتنا الإستراتيجية؛ حيث تحرص الهيئة السعودية للمياه على تجديد وتحسين آليات التواصل للاستماع إلى آراء المستفيدين والعمل على حل شكاواهم، تأكيدًا للالتزام والاهتمام الراسخ بمصالحهم وحقوقهم.</div>
                            {/* <div className="Ps-LinkAr">
                                عرض دليل الخدمة
                        ...
                        <div className="Ps-InfoAr">
                            <div className="Ps-Hor-Tab-ListAr" role="tablist">
                                {[
                                    { id: 'requirements', label: 'المعلومات المطلوبة' },
                                    ...
                                    <button
                                        ...
                                        className={`Ps-Hor-TabAr${activeTab === tab.id ? ' Ps-Hor-Tab--activeAr' : ''
                                            }`}
                            ...
                            <div className="Ps-Tab-PanelAr">
                                {activeTab === 'steps' && (
                                    <div className="Ps-StepsAr" role="tabpanel">
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">1-</div>
                                            <div className="Ps-T-Steps-TextAr">اضغط على "بدء الخدمة".</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">2-</div>
                                            <div className="Ps-T-Steps-TextAr">تعبئة النموذج المطلوب بالمعلومات الشخصية ورسالة الطلب.</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">3-</div>
                                            <div className="Ps-T-Steps-TextAr">إرفاق المستندات (إن وجدت).</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">4-</div>
                                            <div className="Ps-T-Steps-TextAr">إرسال الطلب إلكترونيًا.</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">5-</div>
                                            <div className="Ps-T-Steps-TextAr">متابعة الطلب عبر القنوات المخصصة.</div>
                                        </div>
                                    </div>
                                )}
                                {activeTab === 'requirements' && (
                                    <div className="Ps-Tab-Panel-BodyAr" role="tabpanel">

                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">1-</div>
                                            <div className="Ps-T-Steps-TextAr">تقديم بيانات دقيقة:يجب تقديم بيانات صحيحة ودقيقة عند تقديم طلب المقابلة.</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">2-</div>
                                            <div className="Ps-T-Steps-TextAr">التعديلات:لا يسمح بتعديل أي بيانات في الطلب بعد إنشائه، وفقًا للإجراءات المتبعة.</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">3-</div>
                                            <div className="Ps-T-Steps-TextAr">الوصول للخدمة:يجب توثيق الدخول عبر خدمة نفاذ، والموافقة على الشروط والأحكام لتقديم الطلب.</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">4-</div>
                                            <div className="Ps-T-Steps-TextAr">إمكانية تقديم الطلب:يسمح النظام للمستفيد بتقديم طلب لقاء معالي الرئيس مرة واحدة شهريًا.</div>
                                        </div>
                                        <div className="Ps-List-ItemAr">
                                            <div className="Ps-T-Steps-NumAr">5-</div>
                                            <div className="Ps-T-Steps-TextAr">إجراءات مراجعة الطلب:</div>
                                        </div>
                                        <ul className="Ps-Tab-ListAr Ps-Tab-List--bulletedAr">
                                            <li>يتم مراجعة قيد الطلب خلال يومين من تاريخه.</li>
                                            <li>يتم تحديد موعد اللقاء خلال فترة لا تتجاوز 10 أيام عمل من تاريخ تقديم الطلب.</li>
                                            <li>بعد تحديد الموعد يتم إرسال التفاصيل في رسالة نصية إلى مقدمه.</li>
                                            <li>في حالة تأجيل الموعد من مكتب معالي رئيس الهيئة، يتم تحديد موعد جديد خلال يوم عمل.</li>
                                            <li>في حالة كان اللقاء عبر تقنيات الاتصال المرئي، يتم إرفاق رابط مكالمة الفيديو في الرسالة.</li>
                                            <li>في حالة حضور المستفيد مقدم الطلب إلى لقائه مع معالي رئيس الهيئة، يتم تحويل حالة الطلب إلى 'مكتمل'.</li>
                                            <li>في حالة عدم حضور المستفيد، يتم تغيير حالة الطلب إلى 'ملغي'، سواء كان اللقاء حضوريًا أو عن طريق الاتصال المرئي.</li>
                                        </ul>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="Ps-Info-CardAr">
                        <div className="Ps-IC-Service-InfoAr">
                            <div className="Ps-IC-SI-ContentAr">
                                <div className="Ps-UserAr">
                                ...
                                <div className="Ps-Inner-ContentAr">
                                    <div className="Ps-Inner-Content-T1Ar">الفئة المستهدفة</div>
                                    <div className="Ps-Inner-Content-T2Ar-Blk">فرد</div>
                                </div>
                            </div>
                            <div className="Ps-IC-SI-ContentAr">
                                <div className="Ps-UserAr">
                                ...
                                <div className="Ps-Inner-ContentAr">
                                    <div className="Ps-Inner-Content-T1Ar">مدة تنفيذ الخدمة</div>
                                    <div className="Ps-Inner-Content-T2Ar-Blk">10 يوم</div>
                                </div>
                            </div>
                            <div className="Ps-IC-SI-ContentAr">
                                <div className="Ps-UserAr">
                                ...
                                <div className="Ps-Inner-ContentAr">
                                    <div className="Ps-Inner-Content-T1Ar">قنوات تقديم الخدمة</div>
                                    <div className="Ps-Inner-Content-T2Ar-Blk">بوابة الخدمات</div>
                                </div>
                            </div>
                            <div className="Ps-IC-SI-ContentAr">
                                <div className="Ps-UserAr">
                                ...
                                <div className="Ps-Inner-ContentAr">
                                    <div className="Ps-Inner-Content-T1Ar">تكلفة الخدمة</div>
                                    <div className="Ps-Inner-Content-T2Ar-Blk">مجاني</div>
                                </div>
                            </div>
                        </div>

                        <hr className="Ps-Line-1Ar" />

                        <div className="Ps-Contact-InfoAr">
                            <div className="Ps-Inner-Content-LowerAr">
                                <div className="Ps-Inner-Content-Lower-T1Ar">
                                    الأسئلة الشائعة
                                </div>
                                <div className="Ps-Inner-Content-Lower-T2Ar">
                                    صفحة الأسئلة الشائعة - SWA
                                    <div className="Ps-Inner-Content-Lower-T2-ImgAr">
                            ...
                            <div className="Ps-IC-SI-ContentAr">
                                ...
                                <div className="Ps-Inner-ContentAr">
                                    <div className="Ps-Inner-Content-T1Ar">الهاتف</div>
                                    <div className="Ps-Inner-Content-T2Ar">
                                        19913
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                            <path d="M8.1241 16.25H8.125C11.8283 16.25 13.6867 16.25 14.9683 14.9683C16.18 13.755 16.2425 11.9541 16.2483 8.87581C16.2483 8.53081 15.9692 8.25 15.6242 8.25H15.6225C15.2775 8.25 14.9975 8.52919 14.9975 8.87419C14.9917 11.8667 14.9042 13.2641 14.0833 14.085C13.1675 15 11.4825 15 8.12419 15C4.76585 15 3.08 15 2.165 14.085C1.25 13.1691 1.25 11.4833 1.25 8.12502C1.25 4.76668 1.25002 3.08087 2.16585 2.16504C2.98585 1.34421 4.38331 1.25583 7.37581 1.25C7.72165 1.25 8 0.969186 8 0.624186C7.99917 0.279186 7.72 0 7.375 0H7.37333C4.29416 0.00583333 2.49332 0.0683235 1.28166 1.28166C0 2.56248 0 4.42164 0 8.12491C0 11.8282 0 13.6867 1.28166 14.9683C2.56248 16.25 4.42166 16.25 8.1241 16.25Z" fill="#1B8354" />
                                            <path d="M6.89175 9.45009C7.01425 9.57092 7.17341 9.63173 7.33258 9.63173C7.49342 9.63173 7.6534 9.56925 7.7759 9.44676L14.9251 2.25592C14.9742 2.76092 15.0126 3.55842 14.9951 4.80426C14.9901 5.15009 15.2659 5.43337 15.6109 5.43837C15.9576 5.44671 16.2401 5.16757 16.2451 4.82257C16.2967 1.19825 15.9071 0.807065 15.6978 0.597002C15.4878 0.386968 15.0968 -0.00407002 11.4751 0.0475851C11.1301 0.0525851 10.8542 0.3367 10.8592 0.6817C10.8642 1.02337 11.1434 1.29759 11.4842 1.29759H11.4934C12.7442 1.28009 13.5425 1.31839 14.0459 1.36839L6.88922 8.5659C6.64589 8.8109 6.64675 9.20676 6.89175 9.45009Z" fill="#1B8354" />
                ...
                <div className="Ps-Service-2Ar Ps-Service-2-MargPs-LAr">
                    <div className="Ps-SectionAr">
                        <div className="Ps-Section-ContentAr">
                            <div className="Ps-Section-Content-Title-TAr">الخدمات ذات الصلة</div>
                            {/* <div className="Ps-Section-Content-Desc-TAr">
                                مثال على وصف الخدمة لشراء قطعة أرض لبناء منزلك، يتطلب ذلك
                                توثيق عملية البيع والشراء في المكاتب العدلية أو خدمات التوثيق
                                لتسجيل الملكية باسمك.
                            </div> */}
                        </div>
                        <div className="Ps-FramesAr" id="relatedFrames" ref={framesRef}>
                            {/* البطاقة الأولى */}
                            <div className="Ps-Service-CardAr" data-card-index="0">
                                <div className="Ps-Serivice-Card-Icon-DivAr">
                                    <div className="Ps-Serivice-Card-Icon-Div-InnerAr">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="Ps-Service-Card-ContentAr">
                                    <div className="Ps-Service-Card-Content-T1Ar">
                                        خدمة الاستعلام عن الشكاوى
                                    </div>
                                    <div className="Ps-Service-Card-Content-T2Ar">
                                        تتيح هذه المنصة للمستفيدين الاستعلام عن حالة وتفاصيل
                                        شكاوى خدمات المياه والصرف الصحي الخاصة بهم.
                                    </div>
                                </div>
                                <div className="Ps-Service-Card-TagAr">فرد</div>
                                <button 
                                    className="Ps-Service-Card-ButtonAr"
                            ...
                            {/* البطاقة الثانية */}
                            <div className="Ps-Service-CardAr" data-card-index="1">
                                <div className="Ps-Serivice-Card-Icon-DivAr">
                                    <div className="Ps-Serivice-Card-Icon-Div-InnerAr">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <path d="M15.3029 8.2568C15.5828 7.95146 15.5621 7.47703 15.2568 7.19714C14.9515 6.91724 14.477 6.93787 14.1971 7.24321L9.22644 12.6658L7.28033 10.7197C6.98744 10.4268 6.51256 10.4268 6.21967 10.7197C5.92678 11.0126 5.92678 11.4874 6.21967 11.7803L8.71967 14.2803C8.86432 14.425 9.06178 14.5043 9.26629 14.4998C9.47081 14.4954 9.66464 14.4076 9.80287 14.2568L15.3029 8.2568Z" fill="#067647" />
                                ...
                                <div className="Ps-Service-Card-ContentAr">
                                    <div className="Ps-Service-Card-Content-T1Ar">
                                        خدمة تقارير حوادث المواطنين
                                    </div>
                                    <div className="Ps-Service-Card-Content-T2Ar">
                                        تتيح هذه المنصة للمستخدمين تقديم وإدارة تقارير مخالفات
                                        المواطنين بكفاءة، مما يوفر نظاماً لتوثيق ومعالجة مختلف القضايا.
                                    </div>
                                </div>
                                <div className="Ps-Service-Card-TagAr">فرد</div>
                                <button 
                                    className="Ps-Service-Card-ButtonAr"
                                    onClick={() => handleServiceClick('https://www.swa.gov.sa/ar/services/submit-citizens-violation-report')}
                                >
                                    الذهاب إلى الخدمة
                                </button>
                            </div>
                            ...
                            {/* البطاقة الثالثة */}
                            <div className="Ps-Service-CardAr" data-card-index="2">
                                <div className="Ps-Serivice-Card-Icon-DivAr">
                                    <div className="Ps-Serivice-Card-Icon-Div-InnerAr">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <path d="M15.3029 8.2568C15.5828 7.95146 15.5621 7.47703 15.2568 7.19714C14.9515 6.91724 14.477 6.93787 14.1971 7.24321L9.22644 12.6658L7.28033 10.7197C6.98744 10.4268 6.51256 10.4268 6.21967 10.7197C5.92678 11.0126 5.92678 11.4874 6.21967 11.7803L8.71967 14.2803C8.86432 14.425 9.06178 14.5043 9.26629 14.4998C9.47081 14.4954 9.66464 14.4076 9.80287 14.2568L15.3029 8.2568Z" fill="#067647" />
                                ...
                                <div className="Ps-Service-Card-ContentAr">
                                    <div className="Ps-Service-Card-Content-T1Ar">
                                        خدمة الاستعلام عن تقارير مخالفات المواطنين
                                    </div>
                                    <div className="Ps-Service-Card-Content-T2Ar">
                                        تتيح هذه المنصة للمستفيدين الاستعلام عن حالة وتفاصيل
                                        تقارير مخالفات خدمات المياه والصرف الصحي الخاصة بهم.
                                    </div>
                                </div>
                                <div className="Ps-Service-Card-TagAr">فرد</div>
                                <button 
                                    className="Ps-Service-Card-ButtonAr"
                                    onClick={() => handleServiceClick('https://www.swa.gov.sa/ar/services/inquiry-citizens-violation-report')}
                                >
                                    الذهاب إلى الخدمة
                                </button>
                            </div>
                            ...
                            {/* البطاقة الرابعة */}
                            <div className="Ps-Service-CardAr" data-card-index="3">
                                <div className="Ps-Serivice-Card-Icon-DivAr">
                                    <div className="Ps-Serivice-Card-Icon-Div-InnerAr">
                        ...
                        <div className="Ps-Controls-ContainerAr" id="relatedControls" ref={controlsRef}>
                            <div className="Ps-CarousalAr" role="button" tabIndex="0" data-index="0">
                                <div className="Ps-Carousal-ImgAr Ps-active">
                                    {/* SVG: Dot Indicator */}
                                </div>
                            </div>
                            <div className="Ps-CarousalAr" role="button" tabIndex="0" data-index="1">
                                <div className="Ps-Carousal-ImgAr">
                                    {/* SVG: Dot Indicator */}
                                </div>
                            </div>
                            <div className="Ps-CarousalAr" role="button" tabIndex="0" data-index="2">
                                <div className="Ps-Carousal-ImgAr">
                                    {/* SVG: Dot Indicator */}
                                </div>
                            </div>
                            <div className="Ps-CarousalAr" role="button" tabIndex="0" data-index="3">
                                <div className="Ps-Carousal-ImgAr">
                                    {/* SVG: Dot Indicator */}
                                </div>
                            </div>
                ...
                <div className="Ps-Footer-AboveAr">
                    <div className="Ps-Comments-N-SuggestonsAr">
                        <div className="Ps-CnS-CardAr">
                            <div className="Ps-Cns-Card-Icon-DivAr">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                    <path d="M15.3029 8.2568C15.5828 7.95146 15.5621 7.47703 15.2568 7.19714C14.9515 6.91724 14.477 6.93787 14.1971 7.24321L9.22644 12.6658L7.28033 10.7197C6.98744 10.4268 6.51256 10.4268 6.21967 10.7197C5.92678 11.0126 5.92678 11.4874 6.21967 11.7803L8.71967 14.2803C8.86432 14.425 9.06178 14.5043 9.26629 14.4998C9.47081 14.4954 9.66464 14.4076 9.80287 14.2568L15.3029 8.2568Z" fill="#067647" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.75 21.5C4.81294 21.5 0 16.6871 0 10.75C0 4.81294 4.81294 0 10.75 0C16.6871 0 21.5 4.81294 21.5 10.75C21.5 16.6871 16.6871 21.5 10.75 21.5ZM1.5 10.75C1.5 15.8586 5.64137 20 10.75 20C15.8586 20 20 15.8586 20 10.75C20 5.64137 15.8586 1.5 10.75 1.5C5.64137 1.5 1.5 5.64137 1.5 10.75Z" fill="#067647" />
                                </svg>
                            </div>
                            <div className="Ps-CnS-Card-ContentAr">
                                <div className="Ps-CnS-Card-Content-T1Ar">التعليقات والاقتراحات</div>
                                <div className="Ps-CnS-Card-Content-T2Ar">
                                    لأي استفسار أو ملاحظات حول الخدمات الحكومية، يرجى ملء
                                    المعلومات المطلوبة.
                                </div>
                            </div>
                            <div className="Ps-Cns-Card-ActionsAr">
                                <button className="Ps-CnS-Card-ButtonAr">اتصل بنا</button>
                            </div>
                        </div>
                    </div>

                    <div className="Ps-Modified-DateAr">
                        <div className="Ps-Modified-Date-TAr">
                            تاريخ آخر تعديل: 04/12/2020 - 4:13 مساءً بتوقيت المملكة العربية السعودية
                        </div>
                    </div>

                    <div className="Ps-RatingAr">
                        <div className="Ps-Rating-bodyAr">
                            <div className="Ps-Rating-ContentAr">
                                <div className="Ps-Rating-Content-Right-TAr">1544 تقييم</div>
                                <div className="Ps-RatingStarAr">
                                ...
                                <div className="Ps-Rating-Content-Left-Text-TAr">
                                    تم تقييم هذه الخدمة بمتوسط
                                    <span className="Ps-Rating-Content-Left-Digit-TAr">3.9</span>
                                </div>
                            </div>
                            <div className="Ps-Rating-ActionsAr">
                                <div className="Ps-Rate-TagAr">قيّم هذه الخدمة</div>
                            </div>
                        </div>
                    </div>

                    <div className="Ps-FeedbackAr">
                        <div className="Ps-Feedback-SectionAr">
                            <div className="Ps-Feedback-Section-ContentAr">
                                <div className="Ps-Content-TextAr">هل كانت هذه الصفحة مفيدة؟</div>
                                <div className="Ps-Content-ActionsAr">
                                    <button className="Ps-choiceAr">نعم</button>
                                    <button className="Ps-choiceAr">لا</button>
                                </div>
                            </div>
                            <div className="Ps-Feedback-Section-TextAr">
...
export default PresidentContactRequesArabic;