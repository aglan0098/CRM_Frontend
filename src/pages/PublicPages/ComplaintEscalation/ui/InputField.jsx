...
{required && <span className="text-[#b42318] ml-1 text-[14px]">*</span>}
</div>
      )}
<input
        id={name}
        ...
        className={`w-full h-10 px-4 py-3 border border-[#9da4ae] rounded text-[16px] focus:outline-none focus:ring-1 focus:ring-[#1b8354] ${
          error ? 'border-[#b42318]' : ''
        }`}
        {...props}
      />
