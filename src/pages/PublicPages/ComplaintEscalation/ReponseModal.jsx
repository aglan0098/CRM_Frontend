...
export default function ComplaintFeedbackForm({ 
  ...
  const handleSubmit = async (e) => {
    ...
    if (!jwtHeaders || Object.keys(jwtHeaders).length === 0) {
      setError('Authentication required. Please complete captcha verification first.');
      setIsLoading(false);
      return;
    }
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Complaint Escalation Successfully Created
          </h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{
                ...
                1. How satisfied are you with the overall process? <span style={{color: '#dc2626', fontSize: '12px'}}>*</span>
              </div>
              <div style={{
                display: 'flex',
                gap: '16px',
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{
                ...
                2. How would you rate the clarity of requirements and guidelines? <span style={{color: '#dc2626', fontSize: '12px'}}>*</span>
              </div>
              <div style={{
                display: 'flex',
                gap: '16px',
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <textarea
                ...
                placeholder="Share your suggestions and feedback..."
                rows="4"
                disabled={isLoading}
                style={{
                  width: '100%',
