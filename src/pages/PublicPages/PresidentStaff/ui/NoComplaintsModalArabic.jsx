...
import './NoComplaintsModalArabic.css';

const NoComplaintsModalArabic = ({ isVisible, onClose, onEscalate }) => {
  if (!isVisible) return null;

  return (
    <div className="no-complaints-modal-overlay-ar" onClick={onClose}>
      <div className="no-complaints-modal-content-ar" onClick={(e) => e.stopPropagation()}>
        {/* Section 1: Warning Icon, Close Button, and Title */}
        <div className="no-complaints-modal-section-1-ar">
          {/* Sub-section 1: Warning Icon and Close Button */}
          <div className="no-complaints-modal-section-1-sub1-ar">
            {/* Warning Icon */}
            <div className="no-complaints-modal-icon-ar">
            ...
            {/* Close button */}
            <button 
              className="no-complaints-modal-close-ar"
              onClick={onClose}
              aria-label="إغلاق"
            >
          ...
          {/* Sub-section 2: Title */}
          <div className="no-complaints-modal-section-1-sub2-ar">
            <h2 className="no-complaints-modal-title-ar">لم يتم العثور على شكاوى</h2>
          </div>
        </div>

        {/* Section 2: Body text */}
        <div className="no-complaints-modal-section-2-ar">
          <p className="no-complaints-modal-text-ar">
            لا توجد شكاوى مسجلة لهذا المستخدم.
          </p>
        </div>

        {/* Section 3: Action buttons */}
        <div className="no-complaints-modal-section-3-ar">
          <button 
            className="no-complaints-modal-button-ar no-complaints-modal-button-secondary-ar"
            onClick={onEscalate}
          >
            تصعيد شكوى
          </button>
          <button 
            className="no-complaints-modal-button-ar no-complaints-modal-button-primary-ar"
            onClick={onClose}
          >
            موافق
          </button>
...
export default NoComplaintsModalArabic;
