...
import './RequestLimitReachedModal.css';

const RequestLimitReachedModal = ({ isVisible, onClose }) => {
  if (!isVisible) return null;

  return (
    <div className="request-limit-modal-overlay" onClick={onClose}>
      <div className="request-limit-modal-content" onClick={(e) => e.stopPropagation()}>
        {/* Section 1: Warning Icon, Close Button, and Title */}
        <div className="request-limit-modal-section-1">
          {/* Sub-section 1: Warning Icon and Close Button */}
          <div className="request-limit-modal-section-1-sub1">
            {/* Warning Icon */}
            <div className="request-limit-modal-icon">
            ...
            {/* Close button */}
            <button 
              className="request-limit-modal-close"
              onClick={onClose}
              aria-label="Close"
            >
          ...
          {/* Sub-section 2: Title */}
          <div className="request-limit-modal-section-1-sub2">
            <h2 className="request-limit-modal-title">Request Limit Reached</h2>
          </div>
        </div>

        {/* Section 2: Body text */}
        <div className="request-limit-modal-section-2">
          <p className="request-limit-modal-text">
            You've already submitted a request this month. Please try again next month.
          </p>
        </div>

        {/* Section 3: Action buttons */}
        <div className="request-limit-modal-section-3">
          <button 
            className="request-limit-modal-button request-limit-modal-button-primary"
            onClick={onClose}
          >
            Okay
          </button>
...
export default RequestLimitReachedModal;
