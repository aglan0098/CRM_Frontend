...
import './RequestLimitReachedModalArabic.css';

const RequestLimitReachedModalArabic = ({ isVisible, onClose }) => {
  if (!isVisible) return null;

  return (
    <div className="request-limit-modal-overlay-ar" onClick={onClose}>
      <div className="request-limit-modal-content-ar" onClick={(e) => e.stopPropagation()}>
        {/* Section 1: Warning Icon, Close Button, and Title */}
        <div className="request-limit-modal-section-1-ar">
          {/* Sub-section 1: Warning Icon and Close Button */}
          <div className="request-limit-modal-section-1-sub1-ar">
            {/* Warning Icon */}
            <div className="request-limit-modal-icon-ar">
            ...
            {/* Close button */}
            <button 
              className="request-limit-modal-close-ar"
              onClick={onClose}
              aria-label="إغلاق"
            >
          ...
          {/* Sub-section 2: Title */}
          <div className="request-limit-modal-section-1-sub2-ar">
            <h2 className="request-limit-modal-title-ar">تم بلوغ الحد المسموح</h2>
          </div>
        </div>

        {/* Section 2: Body text */}
        <div className="request-limit-modal-section-2-ar">
          <p className="request-limit-modal-text-ar">
            لقد قدمت طلبًا خلال هذا الشهر. يرجى المحاولة مرة أخرى في الشهر القادم.
          </p>
        </div>

        {/* Section 3: Action buttons */}
        <div className="request-limit-modal-section-3-ar">
          <button 
            className="request-limit-modal-button-ar request-limit-modal-button-primary-ar"
            onClick={onClose}
          >
            موافق
          </button>
...
export default RequestLimitReachedModalArabic;
