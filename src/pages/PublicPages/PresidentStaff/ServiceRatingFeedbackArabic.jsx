...
import './ServiceRatingFeedbackArabic.css';

const ServiceRatingFeedbackArabic = () => {
    return (
        <>
            <div className="PE-Modified-DateAr">
                <div className="PE-Modified-Date-TAr">
                    تاريخ آخر تعديل: 04/12/2020 - 4:13 مساءً بتوقيت المملكة العربية السعودية
                </div>
            </div>

            <div className="PE-RatingAr">
                <div className="PE-Rating-bodyAr">
                    <div className="PE-Rating-ContentAr">
                        <div className="PE-Rating-Content-Right-TAr">1544 تقييم</div>
                        <div className="PE-RatingStarAr">
                        ...
                        <div className="PE-Rating-Content-Left-Text-TAr">
                            تم تقييم هذه الخدمة بمتوسط
                            <span className="PE-Rating-Content-Left-Digit-TAr">3.9</span>
                        </div>
                    </div>
                    <div className="PE-Rating-ActionsAr">
                        <div className="PE-Rate-TagAr">قيّم هذه الخدمة</div>
                    </div>
                </div>
            </div>

            <div className="PE-FeedbackAr">
                <div className="PE-Feedback-SectionAr">
                    <div className="PE-Feedback-Section-ContentAr">
                        <div className="PE-Content-TextAr">هل كانت هذه الصفحة مفيدة؟</div>
                        <div className="PE-Content-ActionsAr">
                            <button className="PE-choiceAr">نعم</button>
                            <button className="PE-choiceAr">لا</button>
                        </div>
                    </div>
                    <div className="PE-Feedback-Section-TextAr">
...
export default ServiceRatingFeedbackArabic;
