        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                تم طلب مقابلة لتقديم إقتراح بنجاح
              </h2>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  ساعدنا بالإجابة على هذه الأسئلة المختصرة:
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              1. ما مدى رضاك عن العملية بشكل عام؟
            </div>
            ...
            <div style={{
              ...
              2. قيم وضوح المتطلبات والإرشادات؟
            </div>
            ...
            <div style={{
              ...
              3. هل ترغب في تقديم ملاحظات إضافية؟
            </div>
