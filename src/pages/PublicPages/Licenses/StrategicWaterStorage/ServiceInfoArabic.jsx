...
const ServiceInfoArabic = () => {
  return (
    <div className="bg-white rounded-2xl border border-border-primary p-6" dir="rtl">
      <div className="flex items-start mb-6">
        ...
        <div className="mr-6">
          ...
          <p className="text-base text-text-secondary">القطاع العام والقطاع الخاص</p>
        </div>
      </div>
      <div className="flex items-start mb-6">
        ...
        <div className="mr-6">
          ...
          <p className="text-base text-text-secondary">15 يوم</p>
        </div>
      </div>
      ...
      <div className="flex items-start mb-6">
        ...
        <div className="mr-6">
          ...
          <p className="text-base text-text-secondary">حسب حجم النشاط</p>
        </div>
      </div>
      
      <hr className="border-t border-border-primary mb-4" />
      
      <h2 className="text-lg font-bold text-text-secondary mb-3">الأسئلة الشائعة</h2>
      
      <a href="#" className="flex items-center text-text-green mb-6">
        <span className="text-base">صفحة الأسئلة الشائعة - هيئة المياه</span>
