...
const RR_DeleteFile = ({ isOpen, onClose, onConfirm, language = 'en' }) => {
  const translations = {
    en: {
      title: 'Delete File',
      message: 'Your data will be removed. Are you sure you want to continue?',
      cancel: 'Cancel',
      delete: 'Delete',
    },
    ar: {
      title: 'حذف الملف',
      message: 'سيتم إزالة بياناتك. هل أنت متأكد من أنك تريد المتابعة؟',
      cancel: 'إلغاء',
      delete: 'حذف',
    },
  };
