...
const RR_SwitchToManual = ({ isOpen, onClose, onConfirm, language = 'en' }) => {
  const translations = {
    en: {
      title: 'Switch to Manual Entry?',
      message: 'Switching to manual entry will clear all data imported from your Excel file. This action cannot be undone.',
      cancel: 'Cancel',
      continue: 'Continue',
    },
    ar: {
      title: 'التبديل إلى الإدخال اليدوي؟',
      message: 'سيؤدي التبديل إلى الإدخال اليدوي إلى مسح جميع البيانات المستوردة من ملف إكسل الخاص بك. لا يمكن التراجع عن هذا الإجراء.',
      cancel: 'إلغاء',
      continue: 'متابعة',
    },
  };
...
export default RR_SwitchToManual;