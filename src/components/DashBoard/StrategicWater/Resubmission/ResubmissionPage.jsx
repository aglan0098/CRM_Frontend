...
import ModificationReq from '../Resubmission/ModificationReq';
import FormSubmitted from '../Resubmission/FormSubmitted';
...
const ResubmissionPage = ({ language = 'en', onLanguageChange }) => {
  ...
  const renderStepComponent = () => {
    ...
    switch (currentStep) {
      case 1:
        return <FormSubmitted language={language} currentStep={currentStep} setCurrentStep={setCurrentStep} />;
      case 2:
  ...
  return (
    <div className={`min-h-screen bg-[#F8F8F8] ${fontClass} ${language === 'ar' ? 'rtl' : 'ltr'}`}>
      <div className="flex-1">
        ...
        {/* ModificationReq Component - Notification card WITHOUT padding */}
        <div className="mx-4 lg:mx-10 -mt-[50px] relative z-10">
          <div className="bg-white rounded-[6px] shadow-[0px_3px_12px_0px_rgba(47,43,61,0.14)]">
            <ModificationReq language={language} />
          </div>
        </div>
