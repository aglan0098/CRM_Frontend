...
const SuccessModalEnglish = ({ language = 'en', onLanguageChange, isOpen, onClose }) => {
  console.log('SuccessModalEnglish - isOpen:', isOpen);
  const handleClose = () => {
    onClose();
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M6 6L18 18M6 18L18 6" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" />
        ...
        <div className="fi-modal-content">
          <h2>Field Inspection Submitted Successfully!</h2>
          <p>Thank you! Your inspection response has been recorded.</p>
        </div>
        
        <div className="fi-modal-footer">
          <button className="fi-btn" onClick={handleClose}>Close</button>
        </div>
      </div>
    </div>
  );
...
export default SuccessModalEnglish;