  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h1 className="headertext">Survey Expired</h1>
        <p className="welcometext">This survey is no longer available</p>
        <p className="welcometext">Please contact support if you need assistance.</p>
        <a className="linkcolro">CMP@SWA.GOV.SA</a>
        <button className="home" onClick={handleHomeNavigation}><p className="but-text">Back To Home</p></button>
      </div>
      <Footer/>
    </>
  );
